    ...
    return (
        <div className='container-fluid bg-light border-top p-5'>
            <div className='row'>
                <div className='col p-2'>
                    ...
                    <div className='social-icons'>
                        <ul className='list-unstyled d-flex fs-4'>
                            <li className='mx-2'><a href="https://www.linkedin.com/company/zerodha" target="_blank" rel="noopener noreferrer">
                                <i class="fa fa-linkedin-square" aria-hidden="true"></i>
                            </a></li>
                            <li className='mx-2'><a href="https://twitter.com/zerodhaonline" target="_blank" rel="noopener noreferrer">
                                <i class="fa fa-twitter-square" aria-hidden="true"></i>
                            </a></li>
                            <li className='mx-2'> <a href="https://www.facebook.com/zerodha" target="_blank" rel="noopener noreferrer">
                                <i class="fa fa-facebook-official" aria-hidden="true"></i>
                            </a></li>
                            <li className='mx-2'> <a href="https://www.instagram.com/zerodha" target="_blank" rel="noopener noreferrer">
                ...
                <div className='col p-2'>
                    <h5>Account</h5>
                    <a href="" className="py-4">Open demat account</a><br />
                    <a href="" className="py-4">Minor demat account</a><br />
                    <a href="" className="py-4">NRI demat account</a><br />
                    <a href="" className="py-4">HUF demat account</a><br />
                    <a href="" className="py-4">Commodity</a><br />
                    <a href="" className="py-4">Dematerialisation</a><br />
                    <a href="" className="py-4">Fund transfer</a><br />
                    <a href="" className="py-4">MTF</a>
                </div>
                <div className='col p-2'>
                    <h5>Support</h5>
                    <a href="" className="py-4">Contact us</a><br />
                    <a href="" className="py-4">Support portal</a><br />
                    <a href="" className="py-4">How to file a complaint?</a><br />
                    <a href="" className="py-4">Status of your complaints</a><br />
                    <a href="" className="py-4">Bulletin</a><br />
                    <a href="" className="py-4">Circular</a>
                    <a href="" className="py-4">Z-Connect blog</a>
                    <a href="" className="py-4">Downloads</a>
                </div>
                <div className='col p-2'>
                    <h5>Company</h5>
                    <a href="" className="py-4"> About</a><br />
                    <a href="" className="py-4">Philosophy</a>  <br />
                    <a href="" className="py-4"> Press & media</a>   <br />
                    <a href="" className="py-4">Leadership</a>  <br />
                    <a href="" className="py-4">Careers</a> <br />
                    <a href="" className="py-4">Zerodha Cares (CSR)</a>     <br />
                    <a href="" className="py-4">Zerodha.tech</a>    <br />
                    <a href="" className="py-4">Open source</a> <br />
                    <a href="" className="py-4">Referral program</a>
                </div>
                <div className='col p-2'>
                    <h5>Quick Links</h5>
            ...
            <div className='container fs-8 font-muted font-size'>
